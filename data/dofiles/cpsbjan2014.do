capture log close
log using cpsbjan2014.log, replace
...
local dat_name "/homes/data/cps-basic/jan14pub.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "cpsb2014_1.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "cpsbjan2014.dct"
