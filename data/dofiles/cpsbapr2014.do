capture log close
log using cpsbapr2014.log, replace
capture set mem 500m

/*------------------------------------------------
  by Jean Roth Thu Mar 19 17:09:45 EDT 2015
  Please report errors to jroth@nber.org
  NOTE:  This program is distributed under the GNU GPL. 
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do cpsbapr2014
----------------------------------------------- */
...
local dat_name "/homes/data/cps-basic/apr14pub.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "cpsb2014_4.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "cpsbapr2014.dct"
...
note: by Jean Roth, jroth@nber.org Thu Mar 19 17:09:45 EDT 2015
