capture log close
log using cpsbjan09.log, replace
set mem 500m

/*------------------------------------------------
  by Jean Roth Mon Feb 22 11:40:45 EST 2010
  Please report errors to jroth@nber.org
  NOTE:  This program is distributed under the GNU GPL. 
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do cpsbjan09
----------------------------------------------- */
...
local dat_name "/homes/data/cps-basic/cpsb0901.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "cpsb2009_1.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "cpsbjan09.dct"
...
note: by Jean Roth, jroth@nber.org Mon Feb 22 11:40:45 EST 2010
...
note puio1mfg: U (PEMLR = 1-3) OR (PEMLR = 4 AND PELKLWO =
note peio2cow: U (PEMLR = 1-3) OR (PEMLR = 4 AND PELKLWO =
...
label define penatvty
	...
	136         "Sweden"                                  
	137         "Switzerland"                             
	138         "United Kingdom/Great Britain"            
	139         "England"                                 
	140         "Scotland"                                
	141         "Wales"                                   
