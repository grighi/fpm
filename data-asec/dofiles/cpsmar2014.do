capture log close
log using cpsmar2014.log, replace

/*------------------------------------------------
  by Jean Roth Fri Sep 18 17:10:13 EDT 2015
  Please report errors to jroth@nber.org
  NOTE:  This program is distributed under the GNU GPL. 
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do cpsmar2014
----------------------------------------------- */
...
local dat_name cpsmar2014.dat

/* The following line should contain the path to your output '.dta' file */

local dta_name cpsmar2014.dta

/* The following line should contain the path to the data dictionary file */

local dct_name cpsmar2014.dct
...
note: by Jean Roth, jroth@nber.org Fri Sep 18 17:10:13 EDT 2015
...
label define a_exprrp
	1           "Reference person with relative"
...
label define i_wcval 
	...
	1           "Allocated from hot deck"       
	2           "Allocated a loss"              
	3           "Statistically matched at Level"
	4           "Statistically matched at Level"
;
...
label define i_phipval
	...
	1           " Allocated at family level (non-"
	2           " Allocated at individual level"
	3           " Missing in family with at least"
	4           " Value changed to $0 because all"
	5           " Logical imputation equal to $0"
;
